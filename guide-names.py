...
##This function returns a .csv file (in the folder from where it is run) of guides names extracted from the FASTA CRISPR library file
docstring="""\nUsage: $ python3 /path/to/guide-names.py /path/to/library.fasta"""

import pandas as pd
import sys

if len(sys.argv) != 2:
    sys.exit('Error: one argument required%s' %(docstring))
